...
Шпаргалка по Claude Code на одном листе A4. Горячие клавиши, команды и настройки собраны в три колонки. Скачай [готовый PDF](./cheatsheet.pdf) или открой [HTML-версию](./index.html) для печати.
...
| 2 | MCP, Память, Приёмы, Оркестрация | **0** (израсходован блоком «Стоимость», 2026-09-10) |
...
Колонка 2 такой же стала после добавления блока «Стоимость — скилл `claude-api`»
(проверено: +1 строка туда — уже вторая страница). Свободна только колонка 1.
