...
Репозитории и проекты, упомянутые в публичных awesome-lists, не подошедшие в узкие категории выше. Здесь — tools, CLI-обёртки, frameworks, статус-лайны, экспериментальные стартеры, demo-проекты.
