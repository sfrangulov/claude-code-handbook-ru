...
|---|---|---:|
| [MCP-серверы](./mcp-servers.md) | все известные серверы из публичных awesome-lists | 828 |
| [Скиллы](./skills.md) | скиллы под конкретные задачи | 164 |
...
| [Экосистема](./ecosystem.md) | утилиты, фреймворки, CLI-обёртки, статус-лайны | 218 |
