...
Слой **под** оркестраторами. Оркестратор решает, кто из агентов какую задачу делает; этот слой владеет терминалами, в которых агенты живут. Поэтому правило «одного оркестратора достаточно» сюда не распространяется: runtime терминалов не конфликтует с gastown или vibe-kanban, он под ними.

Три боли, которые он закрывает, — и все три возникают ровно тогда, когда агентов становится больше одного:
