...
- Чувствительные значения в state — реальность. Шифровать backend (SSE-KMS) и ограничивать доступ.
...
- Большие изменения — через `-target` для постепенного rollout, но избегать `-target` как способа жизни.
